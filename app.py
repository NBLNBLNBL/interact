...
# Affichage horizontal, 1 carte = 1 st.markdown, plus de HTML affiché en brut, largeur dynamique
if st.session_state.results:
    st.markdown('<div class="cards-row-scroll">', unsafe_allow_html=True)
